	...
	<div class="flex flex-col shadow-md cursor-pointer w-96 hover:-translate-y-1 duration-300">
		...
		<div class="inline relative group h-48">
			...
			>
				...
				>
					<i
						class="mdi mdi-playlist-plus text-xl text-gray-200
		...
		<div class="flex flex-col bg-white rounded-b p-3">
			...
			<div class="text-xxs text-gray-400 truncate mt-1">
				...
				<!-- Author -->
				<a class="font-semibold hover:underline"> {author} </a>
			...
			<!-- Price -->
			<div class="text-sm text-gray-600 font-bold mt-4 mb-1">$23</div>
			...
			<div class="flex flex-row mt-2">
				...
				<div class="flex flex-col flex-auto">
					...
					<div class="flex flex-row group">
						...
						<div class="text-xxs text-gray-400 ml-1 hover:underline">(45)</div>
					</div>
				...
				<div class="flex flex-row flex-auto justify-end">
					<!-- Cart Button -->
					<a
						class="flex text-xs border px-3 my-auto py-2 mr-2
					...
					>
						<!-- Icon -->
						<i
							class="mdi mdi-cart-outline text-amber-700
					...
					>
						<!-- Icon -->
						<i
							class="mdi mdi-eye-outline text-amber-700
                            group-hover:text-white delay-100"
						/>
